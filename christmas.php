...
<div class="container-fluid container-2">
    <div class="row">
      <div class="title-main">Karácsony a villában</div>
    </div>
    <div class="row row-2">
        <div class="col-md">
          <div>
    ...
    <div class="row row-2">
        <div class="col col-image">
            <img class="medium-image" src="img/christmas-1.jpg" />
        </div>
        <div class="col col-image">
            <img class="medium-image" src="img/christmas-2.jpg" />
        </div>
        <div class="col col-image">
            <img class="medium-image" src="img/christmas-3.jpg" />
        </div>
        <div class="col col-image">
            <img class="medium-image" src="img/christmas-4.jpg" />
        </div>
        <div class="col col-image">
