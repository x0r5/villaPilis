  ...
  <div class="container-fluid container-2">
    <div class="row">
      <div class="title-main">Miért gyertek hozzánk?</div>
    </div>
    ...
    <div class="row row-2">
      ...
      <div class="col-md-8">
        <div data-aos="fade-left" data-aos-duration="1000" data-aos-offset="200">
          <img class="img-fluid" src="img/medence-1.jpg">
        </div>
      </div>
    </div>
    ...
    <div class="row row-2">
      ...
      <div class="col-md-8">
        <div data-aos="fade-right" data-aos-duration="1000" data-aos-offset="200">
          <img class="img-fluid" src="img/teli-8.jpg">
        </div>
      </div>
  ...
  <div class="container-fluid container-2">
    <div class="row row-2">
      <div class="title-main">Szolgáltatásaink</div>
      <hr>
    </div>
  <div class="row">
    <div class="d-flex flex-wrap justify-content-center service-list">
      <div class="service-item">
        <img class="service-icon" src="svgs/pool-vector.svg">
        <div class="service-text">Medence</div>
      </div>
      <div class="service-item">
        <img class="service-icon" src="svgs/sauna-vector.svg">
        <div class="service-text">Szauna</div>
      </div>
      <div class="service-item">
        <img class="service-icon" src="svgs/tv-vector.svg">
        <div class="service-text">Tv</div>
      </div>
      <div class="service-item">
        <img class="service-icon" src="svgs/airconditioning-vector.svg">
        <div class="service-text">Légkondi</div>
      </div>
      <div class="service-item">
        <img class="service-icon" src="svgs/wifi-vector.svg">
        <div class="service-text">Wifi</div>
      </div>
      <div class="service-item">
        <img class="service-icon" src="svgs/grill-vector.svg">
        <div class="service-text">Grill</div>
      </div>
      <div class="service-item">
        <img class="service-icon" src="svgs/parking-vector.svg">
        <div class="service-text">Parkoló</div>
      </div>
      <div class="service-item">
